...
Application::Application() {
    ...
    // m_Graphs.emplace_back().SetParametric("0.05*16*sin(t)*sin(t)*sin(t) { -pi <= t <= pi }", "0.05*(13*cos(t)-5*cos(2*t)-2*cos(3*t)-cos(4*t))");
    // m_Graphs.emplace_back().SetParametric("0.1*cos(2*t)*cos(t) { 0 <= t <= 2*pi }", "0.1*cos(2*t)*sin(t)");
    // m_Graphs.emplace_back().SetParametric("0.08*cos(3*t)*cos(t) { 0 <= t <= 2*pi }", "0.08*cos(3*t)*sin(t)");
    // m_Graphs.emplace_back().SetParametric("sin(2*t) { -5 <= t <= 5 }", "cos(3*t)");
    // m_Graphs.emplace_back().SetExplicit("x*sin(1/x) { -pi <= x <= pi }");
    // m_Graphs.emplace_back().SetExplicit("x - 1/x^2 { -pi <= x <= pi }");
    // m_Graphs.emplace_back().SetExplicit("0.25*(2-x)/(1+sin(x)) { -10 <= x <= 10 }");
    // m_Graphs.emplace_back().SetExplicit("(x+2)/(x^2+3*x+2) { -10 <= x <= 10 }");
    // m_Graphs.emplace_back().SetExplicit("15*((sin(x)^3*15)-15)/((sin(x)^2*15)^-1-15) { -100 <= x <= 100 }");
}
